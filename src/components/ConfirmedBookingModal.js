...
const ConfirmedBookingModal = props => {
    ...
    <Modal animationType="fade" transparent={true} visible={props?.visible}>
      <View style={styles.Main_Container}>
        <View style={styles.Sub_Container}>
          ...
          <MaterialCommunityIcons name='check-circle' color={Colors.BLUE}  size={80} />
          <TextComponent
          text={props?.title}
          style={{textAlign: 'center', fontWeight: 'bold', fontSize: 17, paddingTop: 5}}
          />

          <Text style={{textAlign: 'center', color:Colors.LIGHT_GRAY}}>{props?.description}</Text>
          </View>
